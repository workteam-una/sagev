...
@Pnombre = 'Miguel',  @Papellido1 = 'Varela', @Papellido2 = 'Ramírez', @Pcontrasenna = 'SdAVMuni2023!',
...
@Pnombre = 'Marco',  @Papellido1 = 'Vega', @Papellido2 = 'Alpízar', @Pcontrasenna = 'SdAVMuni2023!',
@Pencargado = 'S', @PSuplente = 'N', @PAdministrador = 'N';

execute usp_insertar_funcionario @PidFuncionario = '401840322', @PnumDepartamento = 100, @Pcorreo = 'eruiz@munisantodomingo.go.cr',
@Pnombre = 'Ernesto',  @Papellido1 = 'Ruíz', @Papellido2 = 'Rodríguez', @Pcontrasenna = 'SdAVMuni2023!',
