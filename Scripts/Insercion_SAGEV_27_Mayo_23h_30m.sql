...
execute usp_insertar_area @PnumArea = 4, @Pnombre = 'Dirección de unidad tecnica', 
@Pdescripcion = 'Dirección de unidad tecnica';
...
@PnombreDepa = 'Gestion ambiental (Gog. Luis Rubi)';
