...
(Estado in ('Pendiente', 'Cancelada', 'Completada', 'Ausente'));
go
...
@PtelefonoContribuyente varchar(30), @PHora varchar(10), @PFecha date, @PDetalle varchar(255),
...
begin
	...
	telefonoContribuyente, Hora, Fecha, Detalle, Estado, RazonReagenda) values (next value for sec_Id_cita, @PIdFuncionario, 
	@PIdContribuyente,@PNombreContribuyente, @PApellido1Contribuyente, @PApellido2Contribuyente, 
	@PCorreoContribuyente, @PtelefonoContribuyente, @PHora, @PFecha, @PDetalle, @PEstado, @PRazonReagenda);
end;
go
...
begin
	update Cita
		...
		CorreoContribuyente= @PCorreoContribuyente, telefonoContribuyente = @PtelefonoContribuyente, Hora = @PHora, 
